...
const Upcoming = () => {
  ...
  const fetchPreviousMeetings = async () => {
    try {
      setLoading(true);
      const response = await axiosInstance.get('/api/meetings/getAllUpcomingMeetings');
  ...
  return (
    <>
      ...
      <VideoModal open={!!videoModal} onClose={() => setVideoModal(null)} src={videoModal?.video} title={videoModal?.title} />
        ...
        <div className="p-5 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <label className="text-sm font-medium">
              ...
              // Note: Modifying nested objects directly in form state requires careful handling for saving back.
              // For simplicity, this assumes a simple update. For full nested updates, you'd send the whole
              // creatorId object or a specific field to your API.
              />
            </label>
            <label className="text-sm font-medium">
